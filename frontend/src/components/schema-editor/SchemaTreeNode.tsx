...
import { LayoutList, Type, Trash2, ChevronRight, ChevronDown } from 'lucide-react'; // Dodano Chevrons!
      ...
      <div className="flex items-center gap-2">
        ...
        <div 
          ...
          className={`p-1 rounded hover:bg-gray-200 text-gray-500 transition-colors ${
            hasChild ? 'visible cursor-pointer' : 'invisible'
          }`}
        >
        ...
        {/* Ikona Typu Klocka */}
        {data.type === 'section' ? <LayoutList size={16} className="text-blue-500" /> : <Type size={16} className="text-green-500" />}
        <span className="font-medium text-sm text-gray-800">{node.text}</span>
      </div>
