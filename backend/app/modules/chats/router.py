...
def read_chat_messages(
    ...
    try:
        ...
        chat = chat_service.read_chat_messages(user_id=current_user.id, chat_id=chat_id)
...
async def send_chat_message(
    ...
    try:
        ...
        ai_response = await chat_service.complete(user_id=current_user.id, request=request)
