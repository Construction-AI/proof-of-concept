...
def block_level_layout(context, box, bottom_space, skip_stack, containing_block, page_is_empty=..., absolute_boxes=..., fixed_boxes=..., adjoining_margins=..., first_letter_style=..., first_line_style=..., discard=..., max_lines=...): # -> tuple[*tuple[Any, ...], None] | tuple[*tuple[Any | BlockReplacedBox | dict[str, Any] | list[Any] | Literal[False] | None, ...], None]:
    """Lay out the block-level ``box``."""
    ...

def block_level_layout_switch(context, box, bottom_space, skip_stack, containing_block, page_is_empty, absolute_boxes, fixed_boxes, adjoining_margins, first_letter_style, first_line_style, discard, max_lines): # -> tuple[*tuple[Any, ...], None] | tuple[*tuple[Any | BlockReplacedBox | dict[str, Any] | list[Any] | Literal[False] | None, ...], None]:
