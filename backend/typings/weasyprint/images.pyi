...
class RadialGradient(Gradient):
    ...
    def layout(self, width, height, style): # -> tuple[Literal[1], Literal['solid'], None, list[Any], list[Any], list[Any]] | tuple[Literal[1], Literal['solid'], None, list[Any], list[tinycss2.color4.Color | tinycss2.color5.Color | Any | str | None], list[Any]] | tuple[float | Any, Literal['radial'], tuple[*tuple[Any, ...], Any] | Any | tuple[Any | Literal[0], ...] | tuple[Any | Literal['auto'], Any, Any | str, Any | Literal['auto'], Any, Any | str], list[Any] | Any | tuple[Any, *tuple[Any, ...]] | list[int], Any | list[Any], Any | list[Any] | list[float | int]]:
        ...
